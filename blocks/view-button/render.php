...
$inner_classes = TGP_Button_Block_Renderer::build_inner_classes( $style_attrs, 'wp-block-tgp-view-button', $variation_info['has_variation'] );
...
<div class="<?php echo esc_attr( implode( ' ', $outer_classes ) ); ?>">
	...
	>
		<?php if ( $show_icon ) : ?>
			<span class="wp-block-tgp-view-button__icon" aria-hidden="true"><?php echo wp_kses( $view_icon, TGP_SVG_Sanitizer::get_allowed_tags() ); ?></span>
		<?php endif; ?>
